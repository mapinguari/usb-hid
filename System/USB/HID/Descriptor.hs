...
data HIDDescriptor = HIDDescriptor {hIDDescriptorType :: !Word8,
                                    hIDcdHID :: !Version,
...
data HIDReportDesc = HIDReport [HIDReportItem]
                 deriving (Eq,Show)
...
data HIDMainData = HIDMainData {bit0 :: HDMBit0,
                                bit1 :: HDMBit1,
                                bit2 :: HDMBit2,
                                bit3 :: HDMBit3,
                                bit4 :: HDMBit4,
